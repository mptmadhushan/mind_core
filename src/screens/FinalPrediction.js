	...
	function renderQuiz() {
		return (
			<SafeAreaView style={styles.container}>
				<ImageBackground style={{ flex: 1 }} source={require('../assets/final.jpg')}>
							...
							<View>
								{res.predicted_grade === 'Skillful' ? (
									<Text style={styles.title2}>
										{res.predicted_grade}- Your child's performance is very good. You're very lucky
										to have such a child
									</Text>
								) : null}
								{res.predicted_grade === 'Developing' ? (
									<Text style={styles.title2}>
										{res.predicted_grade}- Your child have average performance parents can encourage
										to child for performance even better
									</Text>
								) : null}
								{res.predicted_grade === 'Minimally Effective' ? (
									<Text style={styles.title2}>
										{res.predicted_grade}- Better than ineffective but parents still need to focus
										on child's education
									</Text>
								) : null}
								{res.predicted_grade === 'Ineffective' ? (
									<Text style={styles.title2}>
										{res.predicted_grade}- Parent should pay serious attention to their child!
									</Text>
								) : null}
							</View>
						) : null}
