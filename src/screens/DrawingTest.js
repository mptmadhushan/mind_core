...
const Quiz = ({ navigation }) => {
	...
	const [ curSketch, setCurSketch ] = useState(drawings[Math.floor(Math.random() * drawings.length)]);
	...
	function renderQuiz() {
		return (
			<SafeAreaView style={styles.container}>
				<ImageBackground style={{ flex: 1 }} source={require('../assets/drawbacknew.jpg')}>
						...
						<View style={styles.firstCard}>
								...
								<View style={styles.centeredView}>
									<View style={styles.modalView}>
										<Text style={styles.modalText}>
											Please Draw the image showing in screen on paper. and then press continue
										</Text>
										<Image
							...
							>
								<TouchableOpacity
									...
									activeOpacity={0.5}
									onPress={() => navigation.navigate('DrawingUpload', { curSketch })}
								>
