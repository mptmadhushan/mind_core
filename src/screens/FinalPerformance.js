...
import { SafeAreaView, View, Text, StyleSheet, TouchableOpacity, Image, FlatList, ImageBackground } from 'react-native';
	...
	function renderQuiz() {
		return (
          ...
          source={require('../assets/CONGRATS.png')}> */}
				<ImageBackground style={{ flex: 1 }} source={require('../assets/6ob.gif')}>
					<View style={{ alignItems: 'center', marginTop: 40 }}>
						<View style={styles.leaderBack}>
							{resp ? (
								<View>
									<Text style={styles.title2}>Previous Score</Text>
									<Text style={styles.title5}>IQ :{resp.previous_quiz_scores.toFixed(2)}</Text>
									<Text style={styles.title5}>Speech :{resp.previous_speaking_score}</Text>
									<Text style={styles.title5}>Drawing :{resp.previous_drawing_score}</Text>
								</View>
							) : null}
							<View>
								{/* <Image
						...
						<View style={styles.leaderBack}>
							{resp ? (
								<View>
									...
									<Text style={styles.title5}>IQ :{resp.new_quiz_scores.toFixed(2)}</Text>
									<Text style={styles.title5}>Speech :{resp.new_speaking_score}</Text>
									<Text style={styles.title5}>Drawing :{resp.new_drawing_score}</Text>
								</View>
							) : null}
							<View>
								{/* <Image
						...
						<View style={styles.leaderBack}>
							<View>
								...
								<Text style={styles.des}>
									You're child performance is very good.{'\n'}you are very lucky to have such a child.
								</Text>
							</View>
							<View>
								<Image style={{ height: 100, width: 100 }} source={require('../assets/chart.png')} />
              ...
              <View>
                ...
                <Text style={styles.title4}>:Other</Text>
					...
					>
						...
						/>
						<Text style={styles.title6}>Parent should mark this to contine</Text>
					</View>
					<View style={{ display: 'flex', alignItems: 'center' }}>
						<TouchableOpacity
							style={styles.buttonStyle2}
							activeOpacity={0.5}
							onPress={() => navigation.navigate('FinalPrediction', { userResults })}
						>
