	...
	function renderQuiz() {
		return (
			<ScrollView style={styles.container}>
				<ImageBackground style={{ flex: 1 }} source={require('../assets/CONGRATS.png')}>
                ...
                return ( */}
						...
						{resp ? (
							<View>
								...
								<Text style={styles.title4}>SCORE: {resp.score.toFixed(2)}</Text>
						...
						>
							...
							/>
							<Text style={styles.title6}>Parent should mark this to continue</Text>
						</View>
