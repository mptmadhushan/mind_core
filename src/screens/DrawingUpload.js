	...
	function renderQuiz() {
		return (
			<SafeAreaView style={styles.container}>
				<ImageBackground style={styles.containerNew} source={require('../assets/drawingUp.jpg')}>
							...
							<View style={styles.centeredView}>
								<View style={styles.modalView}>
									<Text style={styles.modalText}>
										please point the camera to your drawing. and then press capture to continue in
										the process.
									</Text>
									<Image
              ...
              source={require('../assets/DrawingChameleon.jpeg')}>
					...
					<View style={styles.container2}>
						<View style={styles.firstCard}>
							<Image style={{ height: '100%', width: '100%' }} source={require('../assets/CAMERA.png')} />
							<TouchableOpacity
